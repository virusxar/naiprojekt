...
print("Ładowanie modelu MobileNetV2...")
model = models.mobilenet_v2(pretrained=True)  # Model wstępnie wytrenowany na ImageNet
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), "mushroom_classifier_mobilenetv2.pth")
    print("Model zapisany jako mushroom_classifier_mobilenetv2.pth")
