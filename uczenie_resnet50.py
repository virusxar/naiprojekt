...
transform = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]),a
])
...
model = models.resnet50(pretrained=True)  # Model wstępnie wytrenowany na ImageNet
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), "mushroom_classifier1_resnet50.pth")
    print("Model zapisany jako mushroom_classifier_resnet50.pth")
